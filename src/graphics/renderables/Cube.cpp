...
const std::vector<VertexData3D> Cube::_cubeVertices({
	...
	// TOP
	{ { -0.5f,  0.5f,  0.5f },{ 95 / 255.0f, 194 / 255.0f, 47 / 255.0f, 1 },{ 0, 1 }, 1 },
	{ {  0.5f,  0.5f,  0.5f },{ 95 / 255.0f, 194 / 255.0f, 47 / 255.0f, 1 },{ 1, 1 }, 1 },
	{ {  0.5f,  0.5f, -0.5f },{ 95 / 255.0f, 194 / 255.0f, 47 / 255.0f, 1 },{ 1, 0 }, 1 },
	{ { -0.5f,  0.5f, -0.5f },{ 95 / 255.0f, 194 / 255.0f, 47 / 255.0f, 1 },{ 0, 0 }, 1 },

	// BOTTOM
	{ { -0.5f, -0.5f, -0.5f },{ 1, 1, 1, 1 },{ 0, 1 }, 2 },
	{ {  0.5f, -0.5f, -0.5f },{ 1, 1, 1, 1 },{ 1, 1 }, 2 },
	{ {  0.5f, -0.5f,  0.5f },{ 1, 1, 1, 1 },{ 1, 0 }, 2 },
	{ { -0.5f, -0.5f,  0.5f },{ 1, 1, 1, 1 },{ 0, 0 }, 2 },
});
